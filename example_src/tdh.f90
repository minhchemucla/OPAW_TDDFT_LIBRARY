subroutine tdh
  !TD Hartree propagation (only V_H and D_xc(V_H,..) changed)
  use mpi_lib_ours
  ...
  do it=1,nt
    call opaw_make_ham_tdh_c16(nn,nocc,nstates,wfs,ham)
    call rk4_prop_opaw_tdh_parallel_c16(nn,nocc,nstates,dt,wfs,ham)

    call opaw_make_ham_tdh_c16(nn,nocc,nstates,wfs_pert,ham_pert)
    call rk4_prop_opaw_tdh_parallel_c16(nn,nocc,nstates,dt,wfs_pert,ham_pert)
