subroutine rk4_prop_opaw_tdh_c16(n,nocc,nstates,dt,p,ham)
  ...
  contains 
    subroutine rk4_step(pin,k,y,dt,last)
      ...
      if(.not.last) then
        call opaw_make_ham_tdh_c16(n,nocc,nstates,y,ham)
      endif
    end subroutine
end subroutine rk4_prop_opaw_tdh_c16

subroutine rk4_prop_opaw_tdh_parallel_c16(n,nocc,nstates,dt,p,ham)
  use opaw_mod, only : dv
  use opaw_ham_mod
  use mpi_lib_ours
  implicit none
  ...
  contains 
    subroutine rk4_step(pin,k,y,dt,last)
      ...
      if(.not.last) then
        ...
        call opaw_make_ham_tdh_c16(n,nocc,nstates,p,ham)
      endif
    end subroutine
end subroutine rk4_prop_opaw_tdh_parallel_c16
