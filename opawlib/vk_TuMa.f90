! Tuckerman Martyna
subroutine prep_vk_opaw( nx,ny,nz,dx,dy,dz,vk,periodic)
!opaw label just to avoid conflict with other prep_vk routines
  use opaw_mod, only : ekcut
  implicit none
  integer nx,ny,nz
  integer ix,iy,iz
  integer st
