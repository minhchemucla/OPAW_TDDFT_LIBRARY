...
subroutine cleb_driver
  use anglib
  implicit none
  integer j1,m1,j2,m2,j,m
  real*8 term
  
99  write(6,*)' give me j1, m1, j2, m2, j, m '
  write(6,*)' we will calculate  < j1/2 m1/2 j2/2 m2/2 |j/2 m/2 > '
  read( 5,*) j1, m1, j2, m2, j, m 
  if(j1<0) stop
  term = cleb(j1,m1,j2,m2,j,m)
  write(6,*)' cleb ',term
  goto 99
end subroutine cleb_driver
