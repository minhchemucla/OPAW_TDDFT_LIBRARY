      ...
      subroutine timer_dn(ttime)
      double precision ttime
c     *********
c
c     Subroutine timer_dn
c
...
c     to subroutine timer_dn to determine the initial and final time.
c
c     The subroutine statement is
c
c       subroutine timer_dn(ttime)
c
c     where
c
