! http://www-meom.hmg.inpg.fr/Web/pages-perso/brankart/Outils/mod_kiss.f90
! ----------------------------------------------------------------------
! FORTRAN90 module to generate random numbers
! with Uniform, Gaussian or Gamma probability distribution
