...
c
 200              return
      ...
      subroutine cdiv2(ar,ai,br,bi,cr,ci)
...
c                     while the j-th eigenvalue is being sought.
c
c     calls cdiv2 for complex division.
c
c     questions and comments should be directed to burton s. garbow,
c     mathematics and computer science div, argonne national laboratory
c
...
c                eigenvector matrix is triangular ..........
         ...
         go to 730
 720         call cdiv2(0.0d0,-h(na,en),h(na,na)-p,q,h(na,na),h(na,en))
 730             h(en,na) = 0.0d0
         h(en,en) = 1.0d0
         enm2 = na - 1
...
c
 ...
 770               m = i
            ...
            call cdiv2(-ra,-sa,w,q,h(i,na),h(i,en))
            go to 790
c     .......... solve complex equations ..........
 ...
 784                  call cdiv2(x*r-zz*ra+q*sa,x*s-zz*sa-q*ra,vr,vi,
     x                h(i,na),h(i,en))
            if (dabs(x) .le. dabs(zz) + dabs(q)) go to 785
            h(i+1,na) = (-ra - w * h(i,na) + q * h(i,en)) / x
            h(i+1,en) = (-sa - w * h(i,en) - q * h(i,na)) / x
            go to 790
 785               call cdiv2(-r-y*h(i,na),-s-y*h(i,en),zz,q,
     x                h(i+1,na),h(i+1,en))
c
c     .......... overflow control ..........
